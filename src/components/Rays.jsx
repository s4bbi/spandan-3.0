...
// React component for the Shader
const ShaderPlane = () => {
  const mesh = useRef();
      ...
      new THREE.ShaderMaterial({
        ...
        fragmentShader: `
          ...
          void main() {
            ...
            // A simple effect using sin and u_time for animation
            color = vec3(sin(st.x + u_time) * 0.5 + 0.5, sin(st.y + u_time) * 0.5 + 0.5, 1.0);
  ...
  useFrame((state) => {
    ...
    if (mesh.current) {
      ...
      mesh.current.material.uniforms.u_resolution.value = [rect.width, rect.height];
    }
  });

  return (
    <mesh ref={mesh} position={[0, 0, 0]}>
      <planeGeometry args={[1440, 1024]} />
...
// below is the component of three js, normal script code make changes accordingly in the above component code
...
<script type="module">
    ...
    const TextureMesh = () => {
        ...
        return React.createElement('mesh',
            ...
            React.createElement('planeGeometry',{args:[1440,1024]}), 
...
void main() {
  gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
                ...
                uniforms: {u_colors: {value: [new THREE.Vector4(1,1,0,1),new THREE.Vector4(1,1,1,1)]},u_intensity: {value: 0.946},u_rays: {value: 0.094},u_reach: {value: 0.211},u_time: {value: 0},u_mouse: {value: [0,0]},u_resolution: {value: [1440,1024]}},
                wireframe: false, 
